  ...
  return (
    <section id="events" className="section-padding max-w-5xl mx-auto overflow-hidden">
      ...
      <div className="relative">
        {/* Center line */}
        <div className="absolute w-0.5 bg-[#7B2FF7]/30 h-full left-4 md:left-1/2 md:-translate-x-1/2"></div>
            ...
            return (
              ...
              >
                ...
                <div className={`w-full pl-12 md:pl-0 md:w-[45%] ${isEven ? 'md:text-right md:pr-12' : 'md:order-2 md:pl-12'}`}>
                  <div className="bg-black/5 dark:bg-white/5 backdrop-blur-sm border border-black/10 dark:border-white/10 rounded-xl p-6">
                ...
                {/* Timeline dot */}
                <div className="absolute left-4 md:left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full bg-[#7B2FF7] border-4 border-[#FFF8EC] dark:border-[#0F0B1E] md:order-1 mt-6 md:mt-0 top-0 md:top-1/2 md:-translate-y-1/2 z-10"></div>
