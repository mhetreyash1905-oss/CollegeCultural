...
export default function SocietyCard({ society, index }: SocietyCardProps) {
  ...
  return (
    ...
    >
      <div 
        className="rounded-xl overflow-hidden bg-paper/5 backdrop-blur-sm border border-paper/10 flex flex-col h-full shadow-lg hover:shadow-2xl transition-shadow"
      ...
      >
        ...
        <div className="p-6 flex-1 flex flex-col pointer-events-none">
          ...
          <h3 className="text-2xl font-serif font-bold text-paper mt-4">{society.name}</h3>
