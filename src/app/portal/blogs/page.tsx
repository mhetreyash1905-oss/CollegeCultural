  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-serif font-bold capitalize">Manage blogs</h1>
        <button 
          onClick={() => {
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-6 shadow-sm mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="${['description', 'content', 'excerpt'].includes('slug') ? 'md:col-span-2' : ''}">
            <label className="block text-sm font-medium mb-1 opacity-80 capitalize">slug</label>
          ...
          <div className="${['description', 'content', 'excerpt'].includes('excerpt') ? 'md:col-span-2' : ''}">
            <label className="block text-sm font-medium mb-1 opacity-80 capitalize">excerpt</label>
          ...
          <div className="${['description', 'content', 'excerpt'].includes('content') ? 'md:col-span-2' : ''}">
            <label className="block text-sm font-medium mb-1 opacity-80 capitalize">content</label>
          ...
          <div className="${['description', 'content', 'excerpt'].includes('coverImageUrl') ? 'md:col-span-2' : ''}">
            <label className="block text-sm font-medium mb-1 opacity-80 capitalize">coverImageUrl</label>
          ...
          <div className="${['description', 'content', 'excerpt'].includes('featured') ? 'md:col-span-2' : ''}">
            <label className="block text-sm font-medium mb-1 opacity-80 capitalize">featured</label>
